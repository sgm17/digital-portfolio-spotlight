  ...
  const blogPosts = [
    {
      ...
      excerpt: 'Learn the best practices for creating Flutter apps that can handle millions of users.',
      date: '2024-01-15',
      readTime: '8 min read',
    ...
    },
    {
      ...
      excerpt: 'Exploring emerging trends and technologies shaping the next generation of social platforms.',
      date: '2024-01-10',
    ...
    },
    {
      ...
      excerpt: 'A comprehensive guide to different revenue models and how to implement them effectively.',
      date: '2024-01-05',
        ...
        <div className="max-w-7xl mx-auto py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <article key={index} className="bg-gray-900 rounded-lg overflow-hidden hover:bg-gray-800 transition-colors duration-300">
