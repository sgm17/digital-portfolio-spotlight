                ...
                <div className="flex items-center p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-blue-400 font-medium">{episode.guestName}</span>
                      <span className="text-gray-500">•</span>
                      <span className="text-blue-400 text-sm">{episode.episodeNumber}</span>
                      <span className="text-gray-500">•</span>
                      <span className="text-gray-400 text-sm">{episode.hostName}</span>
                    </div>
                    
                    <h3 className="text-white font-medium mb-1 leading-tight line-clamp-2">{episode.title}</h3>
